  ...
  export default function ExecutionList({ trade, onUndo }: Props) {
    ...
    return (
      <div className="mt-5 border-t pt-5">
        <p className="mb-3 text-xl font-extrabold text-gray-950">完成明细</p>
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-base font-extrabold text-gray-950">
                    {index + 1}. {item.close_date} {item.close_time || ""}
                  </p>
                ...
                <div className="text-right">
                  ...
                  <button
                    type="button"
                    onClick={() => onUndo(item)}
                    className="mt-2 rounded-lg bg-orange-500 px-3 py-2 text-sm font-bold text-white"
                  >
                    撤销
                  </button>
                </div>
